...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПечатьРеализацииТоваров(ТабДок, ПараметрКоманды);
...
//	ПараметрКоманды - Произвольный - содержит ссылку на объект, для которого вызвана команда печати.
&НаСервере
Процедура ПечатьРеализацииТоваров(ТабДок, ПараметрКоманды)
	Документы.РеализацияТоваров.ПечатьРеализацииТоваров(ТабДок, ПараметрКоманды);
КонецПроцедуры
